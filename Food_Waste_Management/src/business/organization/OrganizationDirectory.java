...
import business.organization.Farmer.FarmerAdminOrganization;
import business.organization.Farmer.FarmerManagerOrganization;
import business.organization.Farmer.FarmerWorkerOrganization;
...
public class OrganizationDirectory {
    ...
    public Organization addOrganization(Type type) {
        ...
        if (type.getValue().equals(Type.NGOAdmin.getValue())) {
            ...
            organizationList.add(organization);
        } else if (type.getValue().equals(Type.FarmerAdmin.getValue())) {
            organization = new FarmerAdminOrganization();
            organizationList.add(organization);
        } else if (type.getValue().equals(Type.FarmerManager.getValue())) {
            organization = new FarmerManagerOrganization();
            organizationList.add(organization);
        } else if (type.getValue().equals(Type.FarmerWorker.getValue())) {
            organization = new FarmerWorkerOrganization();
            organizationList.add(organization);}
        return organization;
    }
