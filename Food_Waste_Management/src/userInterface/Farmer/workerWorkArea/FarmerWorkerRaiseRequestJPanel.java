 ...
 */
public class FarmerWorkerRaiseRequestJPanel extends javax.swing.JPanel {
    ...
    /**
     * Creates new form FarmerWorkerRaiseRequestJPanel
     */
    public FarmerWorkerRaiseRequestJPanel(JPanel userProcessContainer, UserAccount account, String enterpriseName, Network network) {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblHeader.setText("Farmer Worker Work Area - Collection Request");
    ...
    private void btnRaiseRequestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRaiseRequestActionPerformed
        ...
        request.setStatus(RequestStatus.getPickupStatusMessage(7));
