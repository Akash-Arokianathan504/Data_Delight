 ...
 */
public class FarmerWorkerViewRequestLogJPanel extends javax.swing.JPanel {
    private JPanel userProcessContainer;
    private UserAccount account;
    /**
     * Creates new form FarmerWorkerViewRequestLogJPanel
     */
    public FarmerWorkerViewRequestLogJPanel(JPanel userProcessContainer, UserAccount account) {
        initComponents();
    ...
    private void btnViewRequestItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewRequestItemActionPerformed
        ...
        if (selectedRow < 0) {
            ...
            FarmerWorkerViewLogItemJPanel restaurantWorkerViewLogItemJPanel = new FarmerWorkerViewLogItemJPanel(userProcessContainer, cwr);
            CardLayout layout = (CardLayout) userProcessContainer.getLayout();
