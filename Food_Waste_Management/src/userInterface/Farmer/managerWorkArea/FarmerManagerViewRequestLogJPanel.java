 ...
 */
public class FarmerManagerViewRequestLogJPanel extends javax.swing.JPanel {
        private JPanel userProcessContainer;
    private Enterprise enterprise;

    /**
     * Creates new form FarmerManagerViewRequestLogJPanel
     */
    public FarmerManagerViewRequestLogJPanel(JPanel userProcessContainer, Enterprise enterprise) {
        initComponents();
    ...
    public void populateTable() {
        ...
        for (Organization o : enterprise.getOrganizationDirectory().getOrganizationList()) {
            for (UserAccount ua : o.getUserAccountDirectory().getUserAccountList()) {
                if ((ua.getRole().getRoleType().getValue()).equals(Role.RoleType.FarmerWorker.getValue())) {
    ...
    private void btnViewRequestItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewRequestItemActionPerformed
        ...
        if (selectedRow < 0) {
            ...
            FarmerManagerViewLogItemJPanel restaurantWorkerViewLogItemJPanel = new FarmerManagerViewLogItemJPanel(userProcessContainer, cwr);
            CardLayout layout = (CardLayout) userProcessContainer.getLayout();
